...
return
{
  graphics_set =
  {
    animation =
    {
      layers =
      {
        util.sprite_load("__Muria-Graphics__/graphics/entity/biovat/biovat",
        {
    ...
    working_visualisations =
    {
      {
        fadeout = true,
        animation = util.sprite_load("__Muria-Graphics__/graphics/entity/biovat/biovat-animation-dome",
        {
          animation_speed = animation_speed,
          frame_count = 64,
          scale = 0.5,
